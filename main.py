import discord, requests, aiofiles, random, urllib, json, math
...
async def aboutme(ctx):
    embedpict = discord.Embed(colour=0xb27b56)
    embedpict.set_image(url="https://cdn.discordapp.com/attachments/943351762759327839/965560832471736352/2022-04-18_17.16.12.png")

    abtme1 = "I'm GrogBot, the bot made by Luziaf#0001 & JerryDotPy#4249. I'm made for The Grog's Lounge Discord server. I'm still in Beta state so my features will be added or removed."
    ...
    await ctx.send(embed=embedpict)
    await ctx.send(embed=mbed)
...
class Misc(commands.Cog):
    ...
    async def lightmode(self,ctx):
        embed = discord.Embed(title="FLASHBANG!", description="This is how Luzzy sees Discord", colour=0xffffff)
